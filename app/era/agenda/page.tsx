...
import { CITAS_SEMANA } from "@/lib/era/mock-data";
import { VERTICAL_META } from "@/lib/era/verticals";
import type { Vertical } from "@/lib/era/types";

const DIAS = [
  { label: "Lun 13/4", fecha: "2026-04-13" },
  { label: "Mar 14/4", fecha: "2026-04-14" },
  { label: "Mié 15/4", fecha: "2026-04-15" },
  { label: "Jue 16/4", fecha: "2026-04-16" },
  { label: "Vie 17/4", fecha: "2026-04-17" },
];
...
export default function AgendaPage() {
  ...
  const profesionales = [...new Set(CITAS_SEMANA.map((c) => c.profesional.nombre))].sort();

  const filtradas = CITAS_SEMANA.filter((c) => {
